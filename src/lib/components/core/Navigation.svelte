...
<header
  class="bg-background/90 backdrop-blur-lg sticky inset-x-0 top-0 z-10 border-b border-white/[13%]"
>
    ...
    <div class="flex h-16 items-center justify-between gap-8 px-6">
      <div class="flex gap-4">
        ...
        >
          ...
          <span
            class="font-semibold text-foreground text-xl leading-none tracking-wider"
          >
            ANKI
          </span>
        </a>
      ...
      <div class="flex items-center h-full max-md:hidden pr-8">
        ...
        {/each}
        <a aria-label="GitHub repository" href="https://github.com/ankitects/anki" class="px-3 py-2 group">
          <svg
            viewBox="0 0 20 20"
            class="size-5 fill-foreground group-hover:fill-primary"
          >
            <path
